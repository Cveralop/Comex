...
if (isset($_GET['estado_visacion'])) {
  $colname1_modificacion = (get_magic_quotes_gpc()) ? $_GET['estado_visacion'] : addslashes($_GET['estado_visacion']);
}
$colname2_modificacion = "1";
if (isset($_GET['nro_operacion'])) {
  $colname2_modificacion = (get_magic_quotes_gpc()) ? $_GET['nro_operacion'] : addslashes($_GET['nro_operacion']);
}
$colname3_modificacion = "Pendiente.";
if (isset($_GET['sub_estado'])) {
  $colname3_modificacion = (get_magic_quotes_gpc()) ? $_GET['sub_estado'] : addslashes($_GET['sub_estado']);
}
$colname_modificacion = "1";
if (isset($_GET['rut_cliente'])) {
  $colname_modificacion = (get_magic_quotes_gpc()) ? $_GET['rut_cliente'] : addslashes($_GET['rut_cliente']);
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$recordID = $_GET['recordID'];
